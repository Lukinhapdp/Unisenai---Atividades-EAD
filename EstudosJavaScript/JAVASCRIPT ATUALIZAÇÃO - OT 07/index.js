...
// ATVD 1
let livro = new Map();
livro.set('Indiozera no palio do mal', 'Indio');
livro.set('The race walk', 'Sorriso');
livro.set('Golzera HotFire', 'Rafinhas');
console.log(livro);
...
livro.delete('Indiozera no palio do mal');
console.log(livro.has('Indiozera no palio do mal'));
