...
let frutas = ["Melância", "Abacaxi", "Limão"];
...
let usuario = { nome: "Lucas", email: "lucaspereira81582@email.com" };
...
listaDeConvidados("Cleyson", "Lucas", "Roberto", "João", "Gustavo");
...
let infoBasica = { titulo: "It a coisa", diretor: "Stephen King" };
...
let entradas = ["Petisco", "Amendoin"];
let pratosPrincipais = ["Salada Cizer", "Lasanha"];
let sobremesas = ["Petigato", "Sagu"];
