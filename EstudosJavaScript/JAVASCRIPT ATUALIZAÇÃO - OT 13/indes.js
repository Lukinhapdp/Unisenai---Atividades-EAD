...
console.log(saudacao("Marcos")); // Olá, Marcos! Seja bem-vindo(a)!
...
const frutas = ["Abacaxi", "Melância", "Melão", "Carambola", "Limão"];
const frutasOrdenadas = frutas.sort((a, b) => a.localeCompare(b));
console.log("Frutas ordenadas:", frutasOrdenadas); // [ "Abacaxi", "Carambola", "Limão", "Melância", "Melão" ]
